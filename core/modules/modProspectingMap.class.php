...
/**
 * 	\defgroup   prospectingmap     Module ProspectingMap
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/prospectingmap/core/modules directory.
 *  \file       htdocs/prospectingmap/core/modules/modProspectingMap.class.php
 *  \ingroup    prospectingmap
 *  \brief      Description and activation file for module ProspectingMap
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module ProspectingMap
 */
class modProspectingMap extends DolibarrModules
{
    var $extrafields;
	...
	public function __construct($db)
    {
        ...
        $this->numero = 163021;        // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        ...
        $this->description = "Description of module \"Prospecting Map\"";
        ...
        $this->config_page_url = array("setup.php@prospectingmap");
        ...
        $this->langfiles = array("prospectingmap@prospectingmap", "opendsi@prospectingmap");
        ...
        // );
        $this->const = array(
            0 => array('PROSPECTINGMAP_SHOW_MAP_INTO_COMPANY_CARD', 'chaine', '1', '', 0, 'current'),
            1 => array('PROSPECTINGMAP_SEARCH_COORDINATES_URL_ADDRESS', 'chaine', 'https://nominatim.openstreetmap.org/search', '', 0, 'current'),
            2 => array('PROSPECTINGMAP_SEARCH_COORDINATES_URL_PARAMETERS', 'chaine', 'polygon_geojson=1&format=json&q=__ADDRESS__', '', 0, 'current'),
			3 => array('PROSPECTINGMAP_SEARCH_COORDINATES_REQUEST_MODE', 'chaine', 'GET', '', 0, 'current'),
			4 => array('PROSPECTINGMAP_COORDINATES_METRICS', 'chaine', 'EPSG:3857', '', 0, 'current'),
            //5 => array('PROSPECTINGMAP_MAIN_LAYER_MAP', 'chaine', 'OSM', '', 0, 'current'),
        );
        ...
        if (!isset($conf->prospectingmap) || !isset($conf->prospectingmap->enabled)) {
            $conf->prospectingmap = new stdClass();
            $conf->prospectingmap->enabled = 0;
        }
        ...
        */
        ...
        $this->menu[$r] = array('fk_menu' => 'fk_mainmenu=companies,fk_leftmenu=thirdparties',
            'type' => 'left',
            'titre' => 'ProspectingMapMapOfProspects',
            'mainmenu' => '',
            'leftmenu' => 'prospectingmap',
            'url' => '/prospectingmap/map.php',
            'langs' => 'prospectingmap@prospectingmap',
            'position' => 100,
            'enabled' => '$conf->prospectingmap->enabled',
            'perms' => '1',
            'target' => '',
            'user' => 0);
        $r++;
